		...
		<div class="row">
			<div class="admin-nav p-0">
				...
				<div class="list-group list-group-flush">
					...
					<a href="admin-deleteuser.php" class="list-group-item text-light admin-link <?= (basename($_SERVER['PHP_SELF']) ) == 'admin-deleteuser.php' ? "nav-active" : "" ?>">
						<i class="fas fa-user-slash"></i>&nbsp;&nbsp;Usuarios Eliminados
					</a>

					<a href="admin-events.php" class="list-group-item text-light admin-link <?= (basename($_SERVER['PHP_SELF']) ) == 'admin-events.php' ? "nav-active" : "" ?>">
